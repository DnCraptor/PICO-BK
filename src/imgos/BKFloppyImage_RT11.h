...
#define IDS_LC_SPECIFIC_RT11_HDR        724
...
{
		static const char_t RADIX50[050];
		...
		std::string    DecodeRadix50(uint16_t *buf, int len);
		int             EncodeRadix50(uint16_t *buf, int len, std::string &strSrc);
