...
<li>Управляемый тормозистор (значение по умолчанию = 6, соотв. БК-0010) увеличить тормоза: Crlt+F11, ускорить игрушку Ctrl+F12. В отрицательную область значений не уходит, т.е. 0 - соотв. отсутствию задержки вообще и работе на полной скорости пики.</li>
<li></li>
</ul>
