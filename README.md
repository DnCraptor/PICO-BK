...
<ul>
<li>A - разряд 0 параллельного порта (регистр 0177714) - DPAD_A</li>
<li>W - разряд 1 порта</li>
<li>D - разряд 2 порта - DPAD_START</li>
<li>S - разряд 3 порта - DPAD_SELECT</li>
<li>Z - разряд 4 порта</li>
<li>X - разряд 5 порта</li>
<li>O - разряд 6 порта</li>
<li>K - разряд 7 порта</li>
<li>; - разряд 8 порта - DPAD_DOWN</li>
<li>L - разряд 9 порта - DPAD_LEFT</li>
<li>, - разряд 10 порта - DPAD_RIGHT</li>
<li>. - разряд 11 порта</li>
<li>Q - разряд 12 порта - DPAD_B</li>
<li>E - разряд 13 порта</li>
<li>I - разряд 14 порта</li>
<li>P - разряд 15 порта - DPAD_UP</li>
</ul>
...
Биты денди-джойстика №2 (не тестировалось):
<ul>
...
Управление эмулятором с помощью денди-джойстика (первого):
<ul>
<li>START + SELECT - выход в режим менеджера</li>
<li>UP / DOWN - навигация по файловой панели</li>
<li>LEFT - вернуться в режим эмуляции (в режиме меню - аналог Esc)</li>
<li>A - меню конфигурации (в режиме меню - смена значения, аналог пробела)</li>
<li>B - ресет эмулятора (аналог Ctrl + Alt + Del)</li>
<li>SELECT - выбор панели (аналог TAB)</li>
<li>START - выбор действия (аналог Enter)</li>
</ul>
