...
<li>Enter - запустить файл или зайти в папку / смонтировать IMG файл, как диск С и выйти из манагера с ресетом (если не выбрано 10-FDD, то выбирается 0011М).</li>
