...
<li>Ctrl + Tab + "C" - переключение между AY-3-8910 и Covox (по умолчанию)</li>
...
<li>F2 - Сохранить состояние БК в файл bk.snap</li>
<li>Ctrl + F2 - Восстановить состояние БК из файла bk.snap</li>
